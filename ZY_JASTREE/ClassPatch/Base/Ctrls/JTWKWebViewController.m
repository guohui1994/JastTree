...
@interface JTWKWebViewController () <WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler>
...
- (WKWebView *)wkWebView
{
    if (_wkWebView==nil) {
        ...
        //    }];
        _wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, SJHeight, kDeviceWidth, kDeviceHight - SJHeight) configuration:config];
        /* 加载服务器url的方法*/
